...
export const IconLoader = ({ size = 16, className }: IconProps) => (
  <RiLoader4Line size={size} className={`spinner ${className || ''}`} />
)
export const IconCircle = ({ size = 16, className }: IconProps) => (
  <RiCheckboxBlankCircleLine size={size} className={className} />
)
export const IconAlertTriangle = ({ size = 16, className }: IconProps) => (
  <RiAlertLine size={size} className={className} />
)
...
export const IconFlame = ({ size = 16, className }: IconProps) => (
  <RiFireLine size={size} className={className} />
)
...
export const IconSend = ({ size = 16, className }: IconProps) => (
  <RiSendPlane2Line size={size} className={className} />
)
export const IconSparkles = ({ size = 16, className }: IconProps) => (
  <RiSparkling2Line size={size} className={className} />
)
...
export const IconFolder = ({ size = 16, className }: IconProps) => (
  <RiFolderLine size={size} className={className} />
)
export const IconMessage = ({ size = 16, className }: IconProps) => (
  <RiChat3Line size={size} className={className} />
)
export const IconMonitor = ({ size = 16, className }: IconProps) => (
  <RiComputerLine size={size} className={className} />
)
...
export const IconEyeOff = ({ size = 16, className }: IconProps) => (
  <RiEyeOffLine size={size} className={className} />
)
...
export const IconChart = ({ size = 16, className }: IconProps) => (
  <RiPieChartLine size={size} className={className} />
)
export const IconTrendingUp = ({ size = 16, className }: IconProps) => (
  <RiStockLine size={size} className={className} />
)
export const IconTarget = ({ size = 16, className }: IconProps) => (
  <RiFocus2Line size={size} className={className} />
)
export const IconBrain = ({ size = 16, className }: IconProps) => (
  <RiMentalHealthLine size={size} className={className} />
)
...
export const IconKey = ({ size = 16, className }: IconProps) => (
  <RiKeyLine size={size} className={className} />
)
export const IconMic = ({ size = 16, className }: IconProps) => (
  <RiMicLine size={size} className={className} />
)
...
export const IconPower = ({ size = 16, className }: IconProps) => (
  <RiShutDownLine size={size} className={className} />
)
export const IconDatabase = ({ size = 16, className }: IconProps) => (
  <RiDatabase2Line size={size} className={className} />
)
export const IconExternalLink = ({ size = 16, className }: IconProps) => (
  <RiExternalLinkLine size={size} className={className} />
)
export const IconSettings = ({ size = 16, className }: IconProps) => (
  <RiSettings4Line size={size} className={className} />
)
...
export const IconChevronUp = ({ size = 16, className }: IconProps) => (
  <RiArrowUpSLine size={size} className={className} />
)
export const IconCommand = ({ size = 16, className }: IconProps) => (
  <RiCommandLine size={size} className={className} />
)
export const IconBrowser = ({ size = 16, className }: IconProps) => (
  <RiWindowLine size={size} className={className} />
)
export const IconShare = ({ size = 16, className }: IconProps) => (
  <RiShareForwardLine size={size} className={className} />
)
...
export const IconInbox = ({ size = 16, className }: IconProps) => (
  <RiInboxLine size={size} className={className} />
)
export const IconFileList = ({ size = 16, className }: IconProps) => (
  <RiFileListLine size={size} className={className} />
)
export const IconPlay = ({ size = 16, className }: IconProps) => (
  <RiPlayFill size={size} className={className} />
)
export const IconAdd = ({ size = 16, className }: IconProps) => (
  <RiAddLine size={size} className={className} />
)
export const IconClipboard = ({ size = 16, className }: IconProps) => (
  <RiClipboardLine size={size} className={className} />
)
