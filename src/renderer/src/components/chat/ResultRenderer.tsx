...
function IconFolder() {
  return (
    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#eab308" strokeWidth="1.5">
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          {file.size && (
            <>
              <div
                style={{ width: '3px', height: '3px', background: '#333', borderRadius: '50%' }}
              />
              <div
                style={{
                  fontFamily: "'JetBrains Mono', monospace",
    ...
    return (
      <div style={{ marginTop: '8px', width: '100%', maxWidth: '600px' }}>
        ...
        >
          ...
          <div
            style={{
              transform: showTerminal ? 'rotate(180deg)' : 'rotate(0)',
